...
public class hwyUserHandle
{
  ...
  {
    return new ModelAndView("bw/MainIndex");
  }
  ...
  public @ResponseBody Boolean register(String birthday, String address,
    String height, String doctor, String salary, Long teleNum, String pasw,
    String userName)
  {
    UserEntity user = new UserEntity.Builder().setAddress(address)
      .setBrithday(birthday).setHeight(height).setDoctor(doctor)
      .setSalary(salary).setTeleNum(teleNum).setPasw(pasw).setUserName(userName)
      .build();
  ...
  {
    return hwyBizImpl.getParameterByPIds(101, 102, 103, 104, 105, 106, 107, 108,
      109, 110);
  }
  ...
  public @ResponseBody Boolean getRegPhoneVCode(String teleNum,
  ...
  public @ResponseBody Boolean checkRegPhoneVCode(String phoneVCode,
    HttpServletRequest request) throws ClientException
  {
    Integer sessionPhoneVCode = (Integer) request.getSession()
      .getAttribute("phoneVCode");
