	...
	<div class="container main portfolio4column">
        ...
        <div class="sixteen columns row portfolio_filter">
        	<ul>
                ...
                <li><a  href="<%=basePath%>user/lxd/showFocus.action?page=1" >我关注了谁</a><span>|</span></li>
                 ...
                 <li><a  href="<%=basePath%>user/lxd/showFocused.action?page=1" style="color:#FF0000;">谁关注了我</a></li>
            </ul>
		...
		<div class="sixteen columns row teasers portfolio">
              ...
              <div class="four columns teaser all-group web-group">
               ...
               <a target='_BLANK' href="<%=basePath%>user/lxd/toUserInfo.action?userId=${fl.toUserId}&toUserId=${fl.userId}" data-text="查看详细资料" class="hovering">
               ...
               <div class="pluswrap">
                   ...
                   <div class="subline"><a target='_BLANK' href="<%=basePath%>user/lxd/toUserInfo.action?userId=${fl.toUserId}&toUserId=${fl.userId}">查看资料</a></div>
               </div>
            </div>
              </c:forEach>
       ...
       <input type="hidden" id="page" value="${focusCurrentPage}">
        ...
        <span>总页数：</span><span id="totalPage">${focusTotalPage}</span>
              ...
              <a
				href="<%=basePath%>user/lxd/showFocused.action?page=1" onclick="return first()">首页</a>
			<a
				href="<%=basePath%>user/lxd/showFocused.action?page=${focusCurrentPage-1}" onclick="return previous()">上一页</a>
			<a
				href="<%=basePath%>user/lxd/showFocused.action?page=${focusCurrentPage+1}" onclick="return next()">下一页</a>
			<a
				href="<%=basePath%>user/lxd/showFocused.action?page=${focusTotalPage}" onclick="return last()">末页</a>
        </div>
        <!-- News
		================================================== -->
