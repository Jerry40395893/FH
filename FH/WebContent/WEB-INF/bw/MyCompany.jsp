          ...
          <div class="col-md-9 col-sm-7">
            ...
            <div class="row product-list">
              ...
              <div class="col-md-4 col-sm-6 col-xs-12">
                <div class="product-item">
                  <div class="pi-img-wrapper">
                    ...
                    <div>
                      <a href="assets/pages/img/products/model1.jpg" class="btn btn-default fancybox-button">打招呼</a>
                      <a href="#product-pop-up" class="btn btn-default fancybox-fast-view">查看资料</a>
                    </div>
                  </div>
                  <h3><a href="shop-item.html">昵称</a></h3>
                  <div class="pi-price">年龄，地址，身高</div>
              ...
              <div class="col-md-4 col-sm-6 col-xs-12">
                <div class="product-item">
                  <div class="pi-img-wrapper">
                    <img src="<%=basePath%>assets/pages/img/products/model2.jpg" class="img-responsive" alt="Berry Lace Dress">
                    <div>
