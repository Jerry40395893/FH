...
<!-- Site Backgrounds
	...
	<div class="container main portfolio4column">
        ...
        <div class="sixteen columns row portfolio_filter">
        	<ul>
                <li><a class="portfolio_selector" data-group="all-group" href="<%=basePath%>user/lxd/showVisit.action?userId=${user.userId}&page=1&toUserId=0&style=19">我看了谁</a><span>|</span></li>
                <li><a class="portfolio_selector" data-group="web-group" href="<%=basePath%>user/lxd/showVisit.action?userId=0&page=1&toUserId=${user.userId}&style=19">谁看了我</a><span>|</span></li>
                <li><a class="portfolio_selector" data-group="photoshop-group" href="<%=basePath%>user/lxd/showVisit.action?userId=${user.userId}&page=1&toUserId=0&style=20">我攒了谁</a><span>|</span></li>
                <li><a class="portfolio_selector" data-group="concepts-group" href="<%=basePath%>user/lxd/showVisit.action?userId=0&page=1&toUserId=${user.userId}&style=20">谁攒了我</a><span>|</span></li>
                <li><a class="portfolio_selector" data-group="print-group" href="<%=basePath%>user/lxd/showVisit.action?userId=${user.userId}&page=1&toUserId=0&style=19">我关注了谁</a><span>|</span></li>
                
                 <li><a class="portfolio_selector" data-group="print-group" href="<%=basePath%>user/lxd/showVisit.action?userId=0&page=1&toUserId=${user.userId}&style=19">谁关注了我</a></li>
            </ul>
		...
		<div class="sixteen columns row teasers portfolio">
              ...
              <div class="four columns teaser all-group web-group">
               ...
               <a target='_BLANK' href="<%=basePath%>user/lxd/toUserInfo.action?userId=${vl.userId}&toUserId=${vl.toUserId}" data-text="查看详细资料" class="hovering">
               ...
               <div class="pluswrap">
                   ...
                   <div class="topline">去访时间：${vl.time}</div>
       ...
       <input type="hidden" id="page" value="${visitCurrentPage}">
        ...
        <span>总页数：</span><span id="totalPage">${visitTotalPage}</span>
              ...
              <a
				href="<%=basePath%>user/lxd/showVisit.action?userId=${user.userId}&page=1&toUserId=0&style=19" onclick="return first()">首页</a>
			<a
				href="<%=basePath%>user/lxd/showVisit.action?userId=${user.userId}&page=${visitCurrentPage-1}&toUserId=0&style=19" onclick="return previous()">上一页</a>
			<a
				href="<%=basePath%>user/lxd/showVisit.action?userId=${user.userId}&page=${visitCurrentPage+1}&toUserId=0&style=19" onclick="return next()">下一页</a>
			<a
				href="<%=basePath%>user/lxd/showVisit.action?userId=${user.userId}&page=${visitTotalPage}&toUserId=0&style=19" onclick="return last()">末页</a>
        </div>
        <!-- News
		================================================== -->
