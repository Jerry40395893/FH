...
<!-- Site Backgrounds
	...
	<div class="container main portfolio4column">
        ...
        <div class="sixteen columns row portfolio_filter">
        	<ul>
                <li><a  href="<%=basePath%>user/lxd/showVisit.action?page=1" style="color:#FF0000;">我看了谁</a><span>|</span></li>
       ...
       <input type="hidden" id="page" value="${visitCurrentPage}">
        ...
        <span>总页数：</span><span id="totalPage">${visitTotalPage}</span>
              ...
              <a
				href="<%=basePath%>user/lxd/showVisit.action?page=1" onclick="return first()">首页</a>
			<a
				href="<%=basePath%>user/lxd/showVisit.action?page=${visitCurrentPage-1}" onclick="return previous()">上一页</a>
			<a
				href="<%=basePath%>user/lxd/showVisit.action?page=${visitCurrentPage+1}" onclick="return next()">下一页</a>
			<a
				href="<%=basePath%>user/lxd/showVisit.action?page=${visitTotalPage}" onclick="return last()">末页</a>
        </div>
        <!-- News
		================================================== -->
