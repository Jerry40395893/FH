						...
						<td>
							<div class="button-group">
								<a class="button border-main"
									href="<%=basePath%>admin/sj/alertCom.action?comboId=${com.comboId}"
									onclick="return alertCom()"> <span class="icon-edit"></span>
									修改
								</a> &nbsp;&nbsp;<a class="button border-red"
									href="<%=basePath %>admin/sj/delete.action?comboId=${com.comboId}"
									onclick="return del()"> <span class="icon-trash-o"></span>
									删除
								</a>
							</div>
						</td>
