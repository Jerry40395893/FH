...
<body>
	<div class="panel admin-panel">
		<div class="panel-head">
			<strong><span class="icon-key"></span> 套餐修改</strong>
		</div>
		<div class="body-content">
			<form method="post" class="form-x"
				action="<%=basePath%>admin/sj/updateCom.action" id="alertFrom">
				<div class="form-group">
					<div class="label">
						<label for="sitename">套餐名称：</label>
					</div>
					<div class="field">
						<input type="text" class="input w50" id="alertName" name="name"
							size="50" value="${com.name}" />
					</div>
				</div>
				<div class="form-group">
					<div class="label">
				...
				<div class="form-group">
					...
					<div class="field">
						<input type="text" class="input w50" name="discount" size="50"
							value="${com.discount}" id="discount" />
					</div>
				</div>
				<div class="form-group">
					<div class="label">
					...
					<div class="field">
						<input type="text" class="input w50" name="recommend" size="50"
							value="${com.recommend}" id="recommend" />
					</div>
				</div>
				<div class="form-group">
					<div class="label">
