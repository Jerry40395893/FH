...
<body text=#000000 bgColor="#ffffff" leftMargin=0 topMargin=4>
	...
	<div id="main">
		...
		<form name=alipayment id="alipayment" action=alipay.trade.page.pay.jsp method=post
			target="_blank">
					...
					<dd id="btn-dd">
						<span class="new-btn-login-sp">
							<button class="new-btn-login" type="submit"
								...
								style="text-align: center;" onclick="check()">付 款2</button>
