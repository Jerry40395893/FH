...
document.writeln('<div id="meizzDateLayer" style="display: none;font-size:12px;" class="Calendar_Border" onselectstart="return false;">');
document.writeln('<span id="tmpSelectYearLayer"  style="z-index: 9999;position: absolute;top:2px;left:18px;display:none;font-size:12px;"></span>');
document.writeln('<span id="tmpSelectMonthLayer" style="z-index: 9999;position: absolute;top:2px; left:75px;display:none;font-size:12px;"></span>');
document.writeln('<table border="0" cellspacing="1" cellpadding="0" style="width:177px;height:160px;font-size:12px;" bgcolor="#ffffff" onselectstart="return false;">');
document.writeln('<tr><td style = "padding:0;" width="170px" height="23px">');
document.writeln('<div class="Calendar_TopMenu">');
document.writeln('<table border="0px" cellspacing="0px" cellpadding="0px" style="width:175px;height:23px;margin:0;font-size:12px;">');
document.writeln('<tr align="center">');
document.writeln(' <td class="Calendar_TopMenuButton" align="center" bgcolor="" style="font-size:10pt;padding:0;"" onclick="meizzPrevM()" title="向前翻　月" Author="meizz">');
...
//这两行代码可以删除了
//****************************************
document.writeln('<span Author="meizz" id="meizzYearHead" onclick="tmpSelectYearInnerHTML(this.innerHTML);" style="display:none;font-size:12px;"></span><span id="meizzMonthHead"');
document.writeln(' Author="meizz" onclick="tmpSelectMonthInnerHTML(this.innerHTML);" style="display:none;font-size:12px;"></span></td>');
//*************************************************
...
document.writeln('<tr><td style = "padding:0;" width="177px" height="18px" class="Calendar_Week_bg">');
document.writeln(' <table border="0px" cellspacing="0px" cellpadding="0px" style="width:175px;height:1px;margin:0;font-size:12px;" style="cursor:default">');
document.writeln(' <tr align="center">');
document.writeln('  <td style = "padding:0;" class="Calendar_Week_font" Author="meizz">日</td>');
document.writeln('  <td style = "padding:0;" class="Calendar_Week_font" Author="meizz">一</td>');
document.writeln('  <td style = "padding:0;" class="Calendar_Week_font" Author="meizz">二</td>');
document.writeln('  <td style = "padding:0;" class="Calendar_Week_font" Author="meizz">三</td>');
document.writeln('  <td style = "padding:0;" class="Calendar_Week_font" Author="meizz">四</td>');
document.writeln('  <td style = "padding:0;" class="Calendar_Week_font" Author="meizz">五</td>');
document.writeln('  <td style = "padding:0;" class="Calendar_Week_font" Author="meizz">六</td>');
document.writeln(' </tr></table></td></tr>');
document.writeln(' <tr><td style = "padding:0;"  width="175px" height="120px">');
document.writeln('  <table border="0" cellspacing="1" cellpadding="0" style="width:175px;height:120px;margin:0;font-size:12px;" bgcolor="#FFFFFF" style="cursor:default">');
var Calendar_n=0; 
...
document.writeln('<td style = "padding:0" Author="meizz" colspan="5">&nbsp;</td></tr></table></td></tr><tr><td>');
document.writeln('<table border="0px" cellspacing="0px" cellpadding="0px"  bgcolor="#FFFFFF" style="cursor:defaul;width:100%;margin:0;font-size:12px;">');
document.writeln('<tr><td  Author="meizz" align="left" style="white-space:nowrap;padding:0">');
...
document.writeln('<td style = "padding:0;" Author="meizz" align="center">');
document.writeln('<div style = "font-size:12px;" Author="meizz" id="but_TDay" onclick="meizzToday();" onfocus="this.blur();" title="转到今天的日期" class="Calendar_Button2 Beautiful">今天</div>');
document.writeln('<td style = "padding:0;" Author="meizz" align="right">');
...
/* 年月选择面板 */
document.writeln('	<table Author="meizz" id="CalendarSelYM" border="0" cellspacing="0" cellpadding="0" class="Calendar_TableSelYM" bgcolor="" style="display:none;margin:0;font-size:12px;" tag="0">');
document.writeln('<tr><td height="23px"><div class="Calendar_TopMenu">');
document.writeln(' <table Author="meizz" border="0px" cellspacing="0px" cellpadding="0px" style="width:175px;height:23px;margin:0;font-size:12px;"><tr align="center">');
document.writeln('   <td width="100px" align="center" class="Calendar_TopMenuText" Author="meizz">');
...
document.writeln('    <table Author="meizz" cellpadding="0" cellspacing="1" border="0" style="font-size:12px;width:100%;margin:0;"><tr>');
...
for (j=1;j<=20;j++){ 
	...
	document.writeln('    <table Author="meizz" cellpadding="0" cellspacing="1" border="0" style="font-size:13px;width:100%;margin:0;">');
...
document.writeln('    <table Author="meizz" cellpadding="0" cellspacing="1" border="0" style="font-size:11px;width:100%;margin:0;">');
...
document.writeln('</table style = "width:100%;margin:0;font-size:12px;"></td></tr><tr><td style="height:1px;"></td></tr><tr><td></td></tr></table>');
...
/**********************************************************************************************/
	...
	*/
	...
	function Calendar_selMonth(logT){
		...
		var strTemp = m$("Calendar_labYearMonth").innerHTML;
		...
		m$("Calendar_labYearMonth").innerHTML = "";
		// 年月显示面板的 TopMenu 也要 记录一下 xxxx年x月
		m$("Calendar_labYearMonth").innerHTML = strTemp + "年" + logT + "月";
		//************************************ 日历 TopMenu 显示所选 年月
		m$("TempCan").innerHTML = strTemp + "年" + logT + "月";
		meizzTheYear = strTemp;
	    meizzTheMonth = logT;
	
		meizzSetDay(meizzTheYear,meizzTheMonth);

		m$("Calendar_labYearMonth").setAttribute("tag","0000Year0Month");

		// 隐藏日期 年 月 选择 面板
		m$("CalendarSelYM").style.display = "none";
	}
	...
	function Calendar_selYear(logT){
		...
		m$("Calendar_labYearMonth").innerHTML = logT;
		...
		// 显示 选择月 面板
		m$("Calendar_tr_Month").style.display = "";
	}
	...
	function Calendar_selYearInterval(logT){
		...
		// 隐藏 区间年选择 面板
		m$("Calendar_tr_YY").style.display = "none";
		// 显示 年选择 面板
	...
	function Calendar_TopMenu(sDate){
		...
		if(Calendar_getTag(obj) == "0000Year0Month"){
			...
			// TopMenu 显示 年
			m$("Calendar_labYearMonth").innerHTML = logYear;
			m$("Calendar_tr_Month").style.display = "";
		...
		// 显示 选择年 面板
			...
			// 隐藏 选择月 面板
			m$("Calendar_tr_Month").style.display = "none";
		...
		// 显示 选择区间年
			...
			// 获得 TopMenu 中的年
			logTemp  = m$("Calendar_labYearMonth").innerHTML.Val();
			logTemp = getIntervalYear(logTemp);
			// TopManu Label 显示 区间年
			m$("Calendar_labYearMonth").innerHTML = logTemp + "-" + (logTemp +9);
			// 隐藏 选择年 面板
...
/**********************************************************************************************/
	...
	{ //主调函数
	  ...
	  var dads  = m$("meizzDateLayer").style;
	  var th = tt;
	...
	{ 
	  ...
	  with(element){ 
		if (tagName != "INPUT" && getAttribute("Author")==null){
			m$("meizzDateLayer").style.display="none";
			ButtonHS(false);
			m$("CalendarSelYM").style.display="none";
		}
	  }
	...
	function tmpSelectYearInnerHTML(strYear) //年份的下拉框
	{
	  ...
	  var s = "<select Author=meizz name=tmpSelectYear style='font-size:14px;' "
		 s += "onblur='m$(\"tmpSelectYearLayer\").style.display=\"none\"' "
		 s += "onchange='m$(\"tmpSelectYearLayer\").style.display=\"none\";"
	  ...
	  m$("tmpSelectYearLayer").style.display="";
	  m$("tmpSelectYearLayer").style.top="2px";
	  m$("tmpSelectYearLayer").style.left="35px";
	  m$("tmpSelectYearLayer").innerHTML = selectInnerHTML;
	  m$("tmpSelectYear").focus();
	}
	...
	function tmpSelectMonthInnerHTML(strMonth) //月份的下拉框
	{
	  ...
	  var s = "<select Author=meizz name=tmpSelectMonth style='font-size:14px' "
		 s += "onblur='m$(\"tmpSelectMonthLayer\").style.display=\"none\"' "
		 s += "onchange='m$(\"tmpSelectMonthLayer\").style.display=\"none\";"
	  ...
	  selectInnerHTML += "</select>";
	  m$("tmpSelectMonthLayer").style.display="";
	  m$("tmpSelectMonthLayer").style.top="2px";
	  m$("tmpSelectMonthLayer").style.left="68px";
	  m$("tmpSelectMonthLayer").innerHTML = selectInnerHTML;
	  m$("tmpSelectMonth").focus();
	}
	...
	document.onkeydown=function(e){
		...
		if (val==27)m$("meizzDateLayer").style.display="none";
	}
	...
	function ButtonHS(bln){
		if(bln){
			m$("but_BYear").style.display = "none";
			m$("but_BMonth").style.display = "none";
			m$("but_TDay").style.display = "none";
			m$("but_NMonth").style.display = "none";
			m$("but_NYear").style.display = "none";

		}else{
			m$("but_BYear").style.display = "";
			m$("but_BMonth").style.display = "";
			m$("but_TDay").style.display = "";
			m$("but_NMonth").style.display = "";
			m$("but_NYear").style.display = "";
			m$("Calendar_labYearMonth").setAttribute("tag","0000Year0Month");
			// 关闭 年月选择的所有行
			var obj;
			for(var i = 1900 ; i<=2090 ; i=i+10){
